...
export default function HousingPage() {
    ...
    if (housing === undefined) { 
        return <section className="housing_error_page">
            <p className="housing_error_page_text">Malheureusement, le logement que vous recherchez n'est plus disponible ou n'existe pas.</p>
            <NavLink title="Accueil" end to="/home" className="housing_error_page_link">Retourner sur la page d'accueil</NavLink> 
        </section>
    }
